...
class TrainingPipelineConfig:
    def __init__(self,timestamp=datetime.now()):
        ...
        self.artifact_name=training_pipeline.ARIFACT_DIR
...
class DataIngestionConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.training_file_path: str=os.path.join(self.data_ingestion_dir,training_pipeline.DATA_INGESTION_INGESTED_DIR,training_pipeline.TRAIN_FILE_PATH)
        self.testing_file_path: str=os.path.join(self.data_ingestion_dir,training_pipeline.DATA_INGESTION_INGESTED_DIR,training_pipeline.TEST_FILE_PATH)
...
class DataValidationConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.drift_report_file_path: str = os.path.join(self.data_validation_dir,
                                                 ...
                                                 training_pipeline.DATA_VALIDATION_DRIFT_FILE_PATH
                                                 )
...
class ModelTrainingConfig:
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.expected_model_accuracy: float = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
        self.over_fitting_under_fitting_thresold: float = training_pipeline.MODEL_TRAINER_OVER_FITTING_AND_UNDER_FITTING_THRESOLD
